...
const interestOptions: { value: InterestFilter; label: string }[] = [
  { value: "All", label: "All" },
      ...
      <div className="flex gap-1 px-2 pt-2 pb-1 flex-wrap">
        {interestOptions.map((opt) => (
          <button
            ...
            data-testid={`filter-${statusSlug}-${opt.value.toLowerCase()}`}
            className={`text-[10px] leading-none px-1.5 py-1 rounded transition-colors ${
              interestFilter === opt.value
